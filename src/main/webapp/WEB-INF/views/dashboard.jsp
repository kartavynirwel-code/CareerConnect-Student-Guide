...
<div class="main-area">
    ...
    <header class="topbar">
        ...
        <div class="topbar-user">
            <div class="user-avatar">${fn:substring(sessionScope.loggedInUser != null ? sessionScope.loggedInUser.username : 'G', 0, 1)}</div>
            Welcome, <strong>${sessionScope.loggedInUser != null ? sessionScope.loggedInUser.username : 'Guest'}</strong>
        </div>
    </header>
    ...
    <main class="page-content">
        ...
        <section class="panel" id="panel-colleges">
            ...
            <table class="data-table">
                <thead>
                    <tr>
                        <th>#</th><th>College Name</th><th>City</th><th>State</th>
                        <th>Stream</th><th>Type</th><th>Action</th>
                    </tr>
                </thead>
                <tbody>
                    <c:forEach var="college" items="${colleges}" varStatus="status">
        ...
        <section class="panel" id="panel-search">
            ...
            <table class="data-table">
                <thead>
                    <tr>
                        <th>#</th><th>College Name</th><th>City</th>
                        <th>Stream</th><th>Type</th><th>Action</th>
                    </tr>
                </thead>
...
<script>
    ...
    window.location.href = "${pageContext.request.contextPath}/student/Inquiry";
}
    function logout() {
    ...
    function initSearch() {
        /* Reset filters and show full list every time search panel opens */
    ...
    function filterColleges() {
        ...
        var res = colleges.filter(function(c) {
            var matchQ = !q || (c.n    && c.n.toLowerCase().includes(q))
    ...
    function submitInquiry(e) { /* ... your existing code ... */ }
